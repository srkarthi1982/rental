...
const ROOT_APP_URL = import.meta.env.DEV
  ? (import.meta.env.PARENT_APP_URL ?? import.meta.env.PUBLIC_ROOT_APP_URL ?? "http://localhost:2000")
  : (import.meta.env.PUBLIC_ROOT_APP_URL ?? import.meta.env.PARENT_APP_URL ?? `https://${COOKIE_DOMAIN}`);
